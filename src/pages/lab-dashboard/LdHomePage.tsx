...
import { HOME_HELP } from "@/components/lab-dashboard/statsHelpContent";
      ...
      <motion.div variants={fadeIn} initial="hidden" animate="visible">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {isAdmin && <StatsHelpButton pageTitle="Home Dashboard" intro={HOME_HELP.intro} sections={HOME_HELP.sections} />}
          </div>
        </div>
      </motion.div>
